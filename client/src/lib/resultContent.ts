...
export const RESULT_CONTENTS: Record<OperatingStyle, ResultContent> = {
  ...
  balancer: {
    ...
    sharingPrompt:
      '接下來三天，留意你在說「好」之前，身體有沒有先緊了一下。\n\n那個緊，是你的能量在說話。\n\n當你開始聽見它，你會發現——這不是標籤。這是創造者送的禮物。',
    shareText: '我是能量建築師，你是哪一型？',
    nextSteps:
      '關係的品質，從你喝的水開始。\n\n這不是比喻。當你不需要擔心最基本的那一口，你才有餘裕去建造更重要的東西。如果你想知道接下來 14 天怎麼走，我在 LINE 這裡等你。',
    nextStepsCTA: '開始下一步對話 →',
    lineOAUrl: LINE_OA_URL,
  },
  ...
  explorer: {
    ...
    sharingPrompt:
      '接下來三天，留意你在選擇的瞬間，那個「也許試試看」的聲音是怎麼說話的。\n\n那個聲音就是你的羅盤。\n\n當你開始聽懂它，你會發現——這不是標籤。這是創造者送的禮物。',
    shareText: '我是生命航行引水人，你是哪一型？',
    nextSteps:
      '呼吸的品質，決定你能走多遠。\n\n你不怕試，但你需要一個乾淨的出發點。當家裡的空氣被理順了，接下來每一步都會更輕。如果你準備好了，我在 LINE 這裡等你。',
    nextStepsCTA: '開始下一步對話 →',
    lineOAUrl: LINE_OA_URL,
  },
  ...
  builder: {
    ...
    sharingPrompt:
      '接下來三天，留意你在做一個小決定的時候，那個「這能不能長期」的聲音是什麼時候出現的。\n\n那個聲音，就是你的秩序感在說話。\n\n當你開始認出它，你會發現——這不是標籤。這是創造者送的禮物。',
    shareText: '我是秩序累積者，你是哪一型？',
    nextSteps:
      '你早就知道：每個月的錢，流向哪裡，決定了你在哪裡。\n\n理順未來不是多花一筆錢，是讓原本就會花的錢走對方向。系統早就在這裡，見證在累積，平台在等你。如果你想了解接下來 14 天的第一步，我在 LINE 這裡等你。',
    nextStepsCTA: '開始下一步對話 →',
    lineOAUrl: LINE_OA_URL,
  },
};