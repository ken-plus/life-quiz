...
export const LIFE_TYPES: Record<OperatingStyle, {
  ...
  guardian: {
    name: 'guardian',
    displayName: '時光整理師',
    roleTitle: 'Time Curator | Clarity | Inner Peace',
    color: '#C9A876',
    accentColor: '#A0826D',
  },
  balancer: {
    name: 'balancer',
    displayName: '能量建築師',
    roleTitle: 'Energy Architect | Harmony | Connection',
    color: '#7BA89F',
    accentColor: '#5F8B84',
  },
  explorer: {
    name: 'explorer',
    displayName: '探索者型',
    roleTitle: 'Curiosity | Openness | New Paths',
    color: '#D4A574',
    accentColor: '#B88A5C',
  },
  builder: {
    name: 'builder',
    displayName: '秩序累積者',
    roleTitle: 'Builder | Stability | Future Growth',
    color: '#8B9D6F',
    accentColor: '#6B7D54',
  },
};
